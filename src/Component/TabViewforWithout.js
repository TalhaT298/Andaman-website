...
// let cabcard = [];
// let pgcard = [];
export default function TabViewforWithout() {
  ...
  return (
    <Container fluid>
      ...
      >
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 0 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 1 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 2 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 3 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 4 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 5 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 6 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 7 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 8 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 9 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 10 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
        <Tab
          ...
          style={{
            ...
            fontWeight: this.state.value === 11 ? this.state.weight : 'lighter',
            fontSize: '11px',
          }}
        />
      </Tabs> */}

      {/* <TabPanel value={this.state.value || 0} index={0}></TabPanel>
      ...
      <TabPanel value={this.state.value} index={5}></TabPanel>
      <TabPanel value={this.state.value} index={6}></TabPanel>
      <TabPanel value={this.state.value} index={7}></TabPanel>
      <TabPanel value={this.state.value} index={8}></TabPanel>
      <TabPanel value={this.state.value} index={9}></TabPanel>
      <TabPanel value={this.state.value} index={10}></TabPanel>
      <TabPanel value={this.state.value} index={11}></TabPanel> */}
    </Container>
  );
}
