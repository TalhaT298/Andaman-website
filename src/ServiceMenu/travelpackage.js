            ...
            {steps.map((label, i) => (
              <Step key={label}>
                ...
                <StepContent>
                  ...
                  <img alt="superapp"  src={getStepContentImage(props.id,activeStep)} width="405px" height="305px"  />
            ...
            {steps.map((label, i) => (
              <Step key={label}>
                ...
                <StepContent>
                  ...
                  <img  src={getStepContentImage(props.id,activeStep)} width="275px" height="225px"  />
