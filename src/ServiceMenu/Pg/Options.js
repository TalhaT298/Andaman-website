          ...
          <div className="w-52 flex justify-between m-6 gap-2 my-4">
            ...
            <div className="flex items-center gap-8 text-l text-black">
              <button
                ...
                className="px-1 cursor-pointer bg-blue-500 border-black border-solid border-2 text-xl text-center -my-2 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="px-1 cursor-pointer bg-blue-500 border-black border-solid border-2 text-xl text-center -my-2"
              >
                <span className="text-white">+</span>
              </button>
            </div>
