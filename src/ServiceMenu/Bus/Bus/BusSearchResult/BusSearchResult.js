...
const BusSearchResult = ({ result, selected, travellers, travellersInfo }) => {
    ...
    return (
        ...
        w-full max-w-[1220px] h-[338px] mx-auto ms:mx-0 bg-[#FFFFFF] shadow-md rounded-xl flex items-center justify-between px-11 ms:px-6 mb-[59px] ms:flex-col' style={{
            ...
            <div className='w-[103px] h-[22px] mt-11 mb-6 ms:block hidden ms:mt-5 ms:mb-2 ms:mr-80'>
                <p className='font-montserrat font-normal ms:text-[10px] ms:text-start ms:font-bold ms:leading-3 text-lg text-[#112211] whitespace-nowrap'>{date}</p>
            </div>
            ...
            <div className='ms:flex items-center justify-between w-full hidden'>
                <div className='flex items-center justify-between h-8 ms:justify-start ms:w-full'>
                    ...
                    <p className='font-montserrat text-base font-medium text-[#112211] text-opacity-60 ms:text-opacity-100 whitespace-nowrap ml-2 ms:ml-0 ms:text-xl'>{result?.routeNameFrom}</p>
                </div>
                ...
                <div className='flex items-center justify-end ms:w-full'>
                    ...
                    <p className='font-montserrat text-base font-medium text-[#112211] text-opacity-60 whitespace-nowrap ms:text-opacity-100 ms:text-xl'>{result.routeNameTo}</p>
                </div>
            </div>
            {/* mobile responsive bus route name to and from*/}
            ...
            {/* desktop logo */}
            <div className='w-full max-w-[188px] h-[187px] text-center lg:max-w-[100px] ms:hidden'>
            ...
            <div className='flex items-center flex-col justify-between h-[297px] w-full max-w-[868px] lg:max-w-xl'>
                ...
                <div className='flex items-center justify-between w-full max-w-[866px] h-11 ms:hidden lg:max-w-xl airbnbml:max-w-xs'>
                ...
                <div className='flex items-center justify-between w-full max-w-[866px] h-11 ms:hidden lg:w-auto lg:max-w-xl airbnbml:max-w-xs lg:'>
                    <div className='flex items-center justify-between w-[300px] h-8 lg:w-auto ml:w-auto airbnbml:w-auto md:w-auto lg:max-w-xl airbnbml:max-w-xs lg:flex-col lg:h-auto'>
                ...
                <div className='w-[270px] h-12 flex items-center ml-auto justify-between gap-4 mt-11 ms:hidden'>
