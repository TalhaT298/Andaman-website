...
const Search = ({ bus: category }) => {
    ...
    return (
        <>
            <div className='w-full max-w-[1152px] h-28 xl:bg-none bg-white shadow-md rounded-2xl xl:rounded-none mx-auto custom-box-shadow xl:shadow-none mt-[53px] xl:mb-96'>
                <div className='w-full max-w-[1152px] h-[374px] ms:bg-[#FF8682] mx-auto ms:py-24 ms:px-6'>
                    <form action=""
                        onClick={handleSubmit}
                        className='ml-2 w-full max-w-[1152px] mr-6 flex items-center h-28 mx-auto xl:bg-white xl:h-[374px] xl:flex-col xl:py-4 xl:px-[14px] xl:mb-4 ms:rounded-2xl ms:ml-0'
                    >
                        {/* location from  */}
                        <div
                        ...
                        <div className='w-[250px] xl:w-full h-12 relative cursor-pointer z-10 xl:mb-4'>
                            <label htmlFor="From"
                                ...
                                className='font-montserrat text-lg font-normal text-[#000000] flex items-center absolute top-3 left-2 cursor-pointer'>
                                <FaUser className='text-2xl text-[#000000] mr-7 cursor-pointer'></FaUser>
                                Traveller's
                            </label>
                            <input
                                value={travellers}
                                ...
                                onClick={() => setClickTraveller(!clickTraveller)}
                                readOnly
                                className='outline-none rounded cursor-pointer w-[250px] ms:w-full xl:w-full h-12 shadow border border-[#FAFBFC] ml-[1px]
                            pl-10 font-montserrat text-xl pt-1
