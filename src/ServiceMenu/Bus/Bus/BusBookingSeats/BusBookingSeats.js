...
const BusBookingSeats = () => {
  ...
  const { bookingInfo, setBookingInfo, adult, children, infant } =
  ...
  return (
    <div>
      ...
      <div className="w-full max-w-[1244px] h-auto mt-20 mx-auto flex items-center justify-between mb-11 xl:gap-6 sxl:gap-6 lg:flex-col ms:mt-0 px-6">
        <div className="w-full max-w-[792px]">
          ...
          <div className="w-[405px] h-[17px] flex items-center justify-between mb-6 font-montserrat flex-wrap ms:hidden">
            ...
            <HiOutlineChevronRight className="text-[#112211] mx-[14px]"></HiOutlineChevronRight>
            <p className="font-medium text-sm text-[#000000] text-opacity-60">
              Seats
            </p>
          </div>
          ...
          <div
            className="w-full max-w-[792px] bg-[#FFFFFF] h-auto rounded-xl px-6 pt-8 pb-9 mb-[25px] ms:hidden"
            style={{
              boxShadow: "0px 4px 16px rgba(17, 34, 17, 0.05)",
            }}
          >
            <div className="font-montserrat flex items-center justify-between mx-auto mb-[29px]">
              <h1 className="font-bold text-2xl text-[#000000] leading-6">
                {bookingInfo?.busName}
              </h1>
              <h1 className="font-bold text-[32px] text-[#062F7D] leading-6">
                ${bookingInfo?.updatedPrice?.price || 0}
              </h1>
            </div>
            <div className="flex items-center justify-between mb-7">
              ...
              <p className="font-montserrat font-medium text-[#000000] text-opacity-75 text-xl">
            ...
            <div className="flex justify-between mx-auto sxl:mb-5 lg:flex-col">
              <div className="w-full max-w-[262px] h-[86px] flex items-center justify-center rounded-lg border-[0.5px] border-[#FF8682] gap-6 px-8 py-4 mb-4">
                ...
                <div>
                  <p className="font-semibold font-montserrat text-2xl mt-[10px] text-[#000000] leading-7 mb-2">
                    {bookingInfo?.category}
                  </p>
                  <p className="font-montserrat font-medium text-[#000000] text-opacity-60 text-sm leading-4">
                    {bookingInfo?.busName}
                  </p>
                </div>
              </div>
          ...
          <div className="w-full max-w-[790px] bg-[#FF8682] bg-opacity-60 h-[135px] rounded-lg px-4 font-montserrat mb-[25px] ms:hidden">
            <p className="font-bold text-2xl text-[#112211] font-montserrat pt-4 mb-4 leading-7">
        ...
        <div className="h-[694px] mx-auto mb-5">
          ...
          <div className="w-full max-w-[327px] h-5 flex items-center justify-between mb-[22px]">
            <div className="flex items-center justify-center w-[92px] h-5">
              ...
              <p className="font-popins font-normal text-[13px] text-[#262630]">
                Reserved
              </p>
            </div>
            <div className="flex items-center justify-center w-[92px] h-5">
          ...
          <div
            className="w-[345px] bg-[#F2F2F3] h-[600px] border border-dashed border-[#F2F2F3] rounded-xl mx-auto mb-5"
            style={{
