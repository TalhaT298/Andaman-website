    ...
    <div className='py-3 flex-col w-5/6 mx-auto my-auto '>
      ...
      >
        <div className='text-slate-200 flex items-center justify-between mx-auto py-auto px-4 text-center px-auto w-auto xs:flex-col xs:py-2 xs:gap-y-3'>
          <span className='uppercase'>{props.busName}</span>
      ...
      {showFlightInfo && (
        <div className='mx-auto h-60 w-auto my-6 text-white px-auto rounded-lg'>
          <div className='h-60 w-auto bg-slate-700 mx-auto px-auto rounded-lg'>
            <div className='flex flex-col h-60 w-full justify-between mx-auto py-3 p-1 text-center px-auto'>
              ...
              <div className='flex flex-col mx-auto py-2 w-32'>
                <button className='h-10 bg-gradient-to-br to-amber-400 from-pink-500 hover:bg-gradient-to-br hover:to-amber-600 hover:from-pink-600'>Book Now</button>
              </div>
            </div>
          </div>
        </div>
