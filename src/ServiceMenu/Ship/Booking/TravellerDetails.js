...
const TravellerDetails = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < travellerDetails.adult; i++) {
      let object = {
        title: '',
        name: '',
        gender: '',
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < travellerDetails.infant; i++) {
      let object = {
        title: '',
        name: '',
        gender: '',
              ...
              <div className="flex flex-col gap-1 mt-5">
                ...
                <div className="ml-1 mt-5">
                  <input 
                    ...
                    className='mr-2'
                  />
                  <label htmlFor='check'>Agree with 
                    <span className='text-[#549b69]'> terms and conditions</span> and the 
                    <span className='text-[#549b69]'> cancellation policy.</span>
                  </label>
                </div>
              </div>           
