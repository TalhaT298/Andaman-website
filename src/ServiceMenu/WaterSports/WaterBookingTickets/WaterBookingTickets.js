    ...
    return (
        <>
            ...
            <div className='w-full max-w-[1232px] mx-auto font-montserrat my-20'>
                <div className='w-full max-w-[250px] h-4 flex items-center justify-between mb-[22px] sm:hidden'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center flex-col justify-between mb-[18px] font-popins py-6 px-11 rounded-xl w-full max-w-lg' style={{
