...
import { Button, Paper, Step, StepButton, StepContent, StepLabel, Stepper, Typography } from '@material-ui/core';
...
const TravelPackageCover = (props) => {
  ...
  for(let key in props){
    if(key === `fullDescription${packageLength+1}`)
      packageLength++
  }
    ...
    <div className='m-2 py-3 p-2 flex flex-col w-88'>
      ...
      >
        <div className='flex flex-col w-auto h-auto font-Nunito_Sans bg-slate-50 shadow-2xl shadow-slate-200 my-10'>
          ...
          <Stepper orientation='vertical' activeStep={activeStep} style={{backgroundColor:'inherit'}} >     
          <Step>
          ...
          <StepContent>
            <div className='py-2'>
              ...
              <Button disabled={activeStep === 0} onClick={backHandler} style={{marginRight:'5px'}}>Back</Button>
              <Button variant='contained' color='primary' onClick={nextHandler}>Next</Button>
          </StepContent>            
          </Step>
          ...
          <StepContent>
            <div className='py-3'>
              ...
              <Button style={{marginRight:'5px'}} onClick={backHandler}>Back</Button>
              <Button variant='contained' color='primary' onClick={nextHandler}>Next</Button>
          </StepContent>            
          </Step>
          ...
          {props.fullDescription5 ? (
            <Step><StepLabel>DAY 5</StepLabel>
            <StepContent>
              <div className='py-3'>
                <span className='text-slate-700 text-base'>
                  {props.fullDescription5}
          ...
          <Paper square elevation={0} style={{ padding:'10px', marginLeft:'10px',backgroundColor:'inherit' }} >
          ...
          <Stepper nonLinear orientation='vertical' activeStep={activeStepFooter}
            style={{marginTop:'20px',backgroundColor:'inherit'}}>
            <Step>
            <StepButton onClick={() => handleActiveFooter(0)}>INCLUSIVES</StepButton>            
            <StepContent>
              <li>Accommodation as per the class chosen</li>
              <li>Breakfast for 5 occasions during the stay</li>
              <li>Meet and Greet services</li>
              <li>Exclusive Air – conditioned Car for sight seeing and arrival and departure transfers</li>
              <li>Entry tickets / Entry permits / Boat tickets / Ferry tickets wherever required</li>
              <li>Parking Charges</li>
            </StepContent>
            </Step>

            <Step>
            <StepButton onClick={() => handleActiveFooter(1)}>EXCLUSIVES</StepButton>            
            <StepContent>
              ...
              <li> Any additional expenses incurred due to any technical fault</li>
              <li>Expenses of personal nature such as drinks & late check-out</li>
            </StepContent>
            </Step>

            <Step>
            <StepButton onClick={() => handleActiveFooter(2)}>CANCELLATION</StepButton>      
            <StepContent>
